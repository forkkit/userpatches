...
download_binary() {
    BIN_URL=https://nc-files.sfo2.digitaloceanspaces.com/deviceplane/${ARCH}/deviceplane-agent
...
download_and_verify() {
    setup_verify_arch
    verify_downloader wget || fatal 'Can not find curl or wget for downloading files'
    setup_tmp
    download_binary
    setup_binary
}
